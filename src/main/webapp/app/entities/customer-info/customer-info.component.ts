...
export class CustomerInfoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.customerInfoService
      ...
      .subscribe(
        (res: HttpResponse<ICustomerInfo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ICustomerInfo): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInCustomerInfos(): void {
    this.eventSubscriber = this.eventManager.subscribe('customerInfoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICustomerInfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
