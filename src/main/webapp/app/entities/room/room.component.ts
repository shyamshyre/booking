...
export class RoomComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.roomService
      ...
      .subscribe(
        (res: HttpResponse<IRoom[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInRooms(): void {
    this.eventSubscriber = this.eventManager.subscribe('roomListModification', () => this.loadPage());
  }
