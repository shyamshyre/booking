...
import { FinanceDeleteDialogComponent } from 'app/entities/finance/finance-delete-dialog.component';
import { FinanceService } from 'app/entities/finance/finance.service';

describe('Component Tests', () => {
  describe('Finance Management Delete Component', () => {
    let comp: FinanceDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [FinanceDeleteDialogComponent],
      })
        .overrideTemplate(FinanceDeleteDialogComponent, '')
        .compileComponents();
