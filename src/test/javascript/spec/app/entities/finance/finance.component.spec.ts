...
import { FinanceComponent } from 'app/entities/finance/finance.component';
...
describe('Component Tests', () => {
  describe('Finance Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.finances && comp.finances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
